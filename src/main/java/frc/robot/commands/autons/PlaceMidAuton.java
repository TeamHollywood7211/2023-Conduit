...
public class PlaceMidAuton extends CommandBase {
  ...
  public PlaceMidAuton(SolenoidSubsystem solenoidSubsystem, GripSubsystem gripSubsystem, ArmSubsystem armSubsystem){
