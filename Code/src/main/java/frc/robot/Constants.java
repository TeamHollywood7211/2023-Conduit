...
public final class Constants {
  ...
  public static final class CanConstants {
    ...
    public static final int FRONT_LEFT_MODULE_STEER_CANCODER = 3;
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET =83.14;// -Math.toRadians(0.0);
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 26.103+180;//-Math.toRadians(-42);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = 50.45;//-Math.toRadians(0.0);

    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 31;
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 32;
    public static final int BACK_RIGHT_MODULE_STEER_CANCODER = 33;
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 342.246;//-Math.toRadians(-105);
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 5880/60*(14.0 / 50.0) * (25.0 / 19.0) * (15.0 / 45.0)*0.10033*Math.PI;

    public static final double kMaxRotationRadiansPerSecond = kMaxSpeedMetersPerSecond/Math.hypot(kTrackWidth/2, kWheelBase/2);
    ...
    public static double kTranslationSlew = 3;//1.55
    public static double kRotationSlew = 3.00;//3.00
    public static double kControllerDeadband = .02;//.05
